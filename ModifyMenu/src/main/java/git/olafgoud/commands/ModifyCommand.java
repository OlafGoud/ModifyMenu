...
public class ModifyCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		try {
			if (args.length < 3) {
				player.sendMessage(ChatColor.RED  + " " + ChatColor.BOLD + "format: <armor, attackspeed, damage, speed, health> <mainhand, offhand, feet, legs, chest, head, all> <number>");
				return true;
			}
		} catch (Exception e) {
			player.sendMessage(ChatColor.RED  + " " + ChatColor.BOLD + "format: <armor, attackspeed, damage, speed, health> <mainhand, offhand, feet, legs, chest, head, all> <number>");
		...
		case "armor":
			...
			break;
		default:
			player.sendMessage(ChatColor.RED + "format: <armor, attackspeed, damage, speed, health> <mainhand, offhand, feet, legs, chest, head, all> <number>");
			return true;
		}
