...
public class GetLeatherColorCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (args.length == 3) {
			...
			p.getInventory().addItem(colorCode(new ItemStack(Material.LEATHER_BOOTS), color));
			p.getInventory().addItem(colorCode(new ItemStack(Material.LEATHER_LEGGINGS), color));
			p.getInventory().addItem(colorCode(new ItemStack(Material.LEATHER_CHESTPLATE), color));
			p.getInventory().addItem(colorCode(new ItemStack(Material.LEATHER_HELMET), color));
			return true;
